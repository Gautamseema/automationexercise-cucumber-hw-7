...
public class ProductDetailsPage extends Utility  {
    ...
    //@FindBy (xpath = "//h2[normalize-space()='Blue Top']")(//h2[normalize-space()='Blue Top'])
   // @FindBy(xpath = "//div[@class = 'product-details']/div[2]/div/h2")
    ...
    public String verifyTheURL(){
        waitUntilVisibilityOfElementLocated(By.xpath("//a[normalize-space()='Write Your Review']"), 3);
